...
class Index1 extends MY_Controller {
	...
	public function index()
	{
		...
		$this->parameters['head_title'] = 'Dashboard 1';
		...
		$this->admin_design->layout('index1', $this->config->item('pathViewTemplateAdmin') . 'index1', $this->parameters);
